        ...
        <Routes>
            <AppRoute path="/" component={LevelNavIndex} isPrivate={true} requiresPlayer={true} />
                ...
                <AppRoute path="Jump/" component={SkillNavigationPage} Levels={JumpLevels} SkillName={'Jump'} isPrivate={true} requiresPlayer={true} />
                    ...
                    <AppRoute path={`Jump/${JumpLevels[0].to}`} component={GameWrapper} Game={CardsGame} isPrivate={true} requiresPlayer={true} backButton={<BackButton />} shuffledImages={CardsJumpFeet} numLevels={JumpLevels[0].numLevels} SkillName="Jump" GameName={JumpLevels[0].name} />
                    <AppRoute path={`Jump/${JumpLevels[1].to}`} component={GameWrapper} Game={CardsGame} isPrivate={true} requiresPlayer={true} backButton={<BackButton />} shuffledImages={CardsJumpKnees} numLevels={JumpLevels[1].numLevels} SkillName="Jump" GameName={JumpLevels[1].name} />
                ...
                <AppRoute path="Balance/" component={SkillNavigationPage} Levels={BalanceLevels} SkillName={'Balance'} isPrivate={true} requiresPlayer={true} />
                    <AppRoute path={`Balance/${BalanceLevels[2].to}`} component={GameWrapper} Game={MixAndMatch} isPrivate={true} requiresPlayer={true} backButton={<BackButton />} shuffledImages={MaMBalanceArms} numLevels={BalanceLevels[2].numLevels} SkillName="Balance" GameName={BalanceLevels[2].name} />
                    <AppRoute path={`Balance/${BalanceLevels[0].to}`} component={GameWrapper} Game={CardsGame} isPrivate={true} requiresPlayer={true} backButton={<BackButton />} shuffledImages={CardsBalanceEyes} numLevels={BalanceLevels[0].numLevels} SkillName="Balance" GameName={BalanceLevels[0].name} />
                    <AppRoute path={`Balance/${BalanceLevels[1].to}`} component={GameWrapper} Game={CardsGame} isPrivate={true} requiresPlayer={true} backButton={<BackButton />} shuffledImages={CardsBalanceLegs} numLevels={BalanceLevels[1].numLevels} SkillName="Balance" GameName={BalanceLevels[1].name} />

                <AppRoute path="Run/" component={SkillNavigationPage} Levels={RunLevels} SkillName={'Run'} isPrivate={true} requiresPlayer={true} />
                    <AppRoute path={`Run/${RunLevels[1].to}`} component={GameWrapper} Game={MixAndMatch} isPrivate={true} requiresPlayer={true} backButton={<BackButton />} shuffledImages={MaMRunArms} numLevels={RunLevels[1].numLevels} SkillName="Run" GameName={RunLevels[1].name} />
                    <AppRoute path={`Run/${RunLevels[2].to}`} component={GameWrapper} Game={MixAndMatch} vertical isPrivate={true} requiresPlayer={true} backButton={<BackButton />} shuffledImages={MaMRunKnees} numLevels={RunLevels[2].numLevels} SkillName="Run" GameName={RunLevels[2].name} />
                    <AppRoute path={`Run/${RunLevels[0].to}`} component={GameWrapper} Game={CardsGame} isPrivate={true} requiresPlayer={true} backButton={<BackButton />} shuffledImages={CardsRunEyes} numLevels={RunLevels[0].numLevels} SkillName="Run" GameName={RunLevels[0].name} />
                    
                <AppRoute path="Throw/" component={SkillNavigationPage} Levels={ThrowLevels} SkillName={'Throw'} isPrivate={true} requiresPlayer={true} />
                    <AppRoute path={`Throw/${ThrowLevels[0].to}`} component={GameWrapper} Game={ThrowEyes} isPrivate={true} requiresPlayer={true}  backButton={<BackButton />} shuffledImages={HotSpotThrowEyes} numLevels={ThrowLevels[0].numLevels} SkillName="Throw" GameName={ThrowLevels[0].name} /> 
